...
class RecruiterConnections extends StatefulWidget {
  @override
  _RecruiterConnectionsState createState() => _RecruiterConnectionsState();
}

class _RecruiterConnectionsState extends State<RecruiterConnections> {
  bool switchValueOne;
  bool switchValueTwo;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: CandidateDrawer(currentPage: "RecruiterConnections"),
        body: Container(

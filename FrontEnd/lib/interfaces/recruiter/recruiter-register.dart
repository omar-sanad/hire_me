...
class RecruiterRegister extends StatefulWidget {
  @override
  _RecruiterRegisterState createState() => _RecruiterRegisterState();
}

class _RecruiterRegisterState extends State<RecruiterRegister> {
  ...
  Future<dynamic> register(
      BuildContext context, String first, String last, String email, String password, String identity, String phone) async {
    if (email.trim() == '' || password.trim() == '') {
      ...
      final response = await http.post(
        Uri.parse(Api.baseUrl + '/recruiters/register'),
